...
UI_LABEL_TR: dict[str, str] = {
    ...
    "RETRY": "TEKRAR DENE",
    "SKIP_SELF_TEST": "GEÇ",
    "DEV_MODE_BANNER": "GELİŞTİRME MODU",
    ...
    "MORPH_KERNEL_AUTO_HINT": "0 = OTOMATİK (varsayılan boşluk genişliğinden hesaplanır)",
    ...
    "REQUIRE_SOLIDITY_LABEL": "DOLULUK ZORUNLU (önerilmez -- kanatlı hedeflerde ters etki yapar)",
    "REQUIRE_SPECULAR_BRIDGING_LABEL": "PARLAKLIK KÖPRÜLEME",
    "HIGHLIGHT_V_MIN_LABEL": "PARLAKLIK EŞİĞİ",
    "HIGHLIGHT_MAX_FRACTION_LABEL": "MIN. HEDEF ORANI",
    ...
    "EYEDROPPER_OFF": "KAPALI",
    "EYEDROPPER_POSITIVE": "POZİTİF ÖRNEK",
    "EYEDROPPER_NEGATIVE": "NEGATİF ÖRNEK",
    "EYEDROPPER_HINT": "Önizlemede tıkla (nokta) veya sürükle (dikdörtgen) ile örnek al.",
    "EYEDROPPER_WRAP_TAG": " [TON SARMASI]",
    "EYEDROPPER_POSITIVE_SUMMARY": "H:{hue:.0f} S:{sat:.0f} V:{val:.0f} ({pixels} piksel){wrap}",
    "EYEDROPPER_NEGATIVE_HIT": "{cls}: KABUL EDİYOR — {field} değerini {value} yap",
    "EYEDROPPER_NEGATIVE_CLEAR": "{cls}: reddediyor",
    "EYEDROPPER_APPLY": "UYGULA",
    "EYEDROPPER_CANCEL": "İPTAL",
    "CLOSE_BUTTON": "KAPAT",
